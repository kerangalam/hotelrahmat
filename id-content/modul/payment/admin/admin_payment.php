...
$admin .='<section class="content-header">
<a class="btn btn-default btn-flat" href="?opsi=payment&amp;modul=yes"><i class="fa fa-fw fa-list"></i> All Promotions <span class="badge bg-green">'.$jumlah.'</span></a>
<a class="btn btn-default btn-flat" href="?opsi=payment&amp;modul=yes&amp;status=Active">Active Promotions</a>
<a class="btn btn-default btn-flat" href="?opsi=payment&amp;modul=yes&amp;status=Expired">Expired Promotions</a>
<a class="btn btn-default btn-flat" href="?opsi=payment&amp;modul=yes&amp;aksi=add_coupon"><i class="fa fa-fw fa-plus"></i> Add New Promotion</a>
<a class="btn btn-default btn-flat" href="?opsi=payment&amp;modul=yes&amp;aksi=rekening">Rekening Pembayaran</a>
</section>';
